...
// @include        http://*.watercooler-inc.com/*main_src.php*
// @include        http://*.watercooler-inc.com/*newgame.php*
// @include        http://apps.facebook.com/betasofcamelot/*
...
var KOCAttack={
	...
	ReloadWindow:function() {
		...
		var goto = 'http://apps.facebook.com/betasofcamelot/?s='+m[1];
			...
			if(t.options.autoPublishGamePopups){
				...
				if(FBInputForm){
					...
					if(channel_input){
						...
						if (current_channel_url.match(/watercooler-inc\.com\/.{0,100}\/cross_iframe\.htm/i)) {
	...
	*/
	...
	DetermineCurrentPage:function() {
		if(unsafeWindow.location.href.match(/watercooler-inc\.com\/fb\/.*?\/standAlone\.php/i)){
			this.currentPage = 'kabam_page';
		}else if(unsafeWindow.location.href.match(/watercooler-inc\.com\/fb\/.*?\/src\/main_src\.php/i)){
			this.currentPage = "koc_game";
		}else if (unsafeWindow.location.href.match(/apps\.facebook\.com\/betasofcamelot\/.*?page=nogame/i)) {
			this.currentPage = "domain_selection_app_page";
		}else if (unsafeWindow.location.href.match(/apps\.facebook\.com\/betasofcamelot/i)) {
		...
		}else if(unsafeWindow.location.href.match(/watercooler-inc.com\.com\/fb\/.*?\/src\/newgame_src\.php/i)){
...
if(location.href.indexOf('apps.facebook.com/betasofcamelot/')>=0) {
	window.setTimeout(function() {
