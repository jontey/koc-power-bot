...
// TODO: Make sure WinPos is visible on-screen ?
  ...
  mainPop = new CPopup ('pb', Options.pbWinPos.x, Options.pbWinPos.y, 755,600, Options.pbWinDrag, 
      function (){
        tabManager.hideTab();
...
Tabs.Reassign = {
  ...
  count:0,
    ...
    init: function(div){
      ...
      m += '<INPUT id=pbtargetSupplyTroops disabled=true type=text size=6 maxlength=6 value="0"\></td>';
      m += '<TD><INPUT id=pbMilitiaman type=checkbox unchecked=true\>';
      m += '<INPUT id=pbtargetMilitiaman disabled=true type=text size=6 maxlength=6 value="0"\></td>';
      m += '<TD><INPUT id=pbScout type=checkbox unchecked=true\>';
      m += '<INPUT id=pbtargetScout disabled=true type=text size=6 maxlength=6 value="0"\></td>';
      m += '<TD><INPUT id=pbPikeman type=checkbox unchecked=true\>';
      m += '<INPUT id=pbtargetPikeman disabled=true type=text size=6 maxlength=6 value="0"\></td></tr>';
      ...
      m += '<INPUT id=pbtargetSwordsman disabled=true type=text size=6 maxlength=6 value="0"\></td>';
      m += '<TD><INPUT id=pbArcher type=checkbox unchecked=true\>';
      m += '<INPUT id=pbtargetArcher disabled=true type=text size=6 maxlength=6 value="0"\></td>';
      m += '<TD><INPUT id=pbCavalry type=checkbox unchecked=true\>';
      m += '<INPUT id=pbtargetCavalry disabled=true type=text size=6 maxlength=6 value="0"\></td>';
      m += '<TD><INPUT id=pbHeavyCavalry type=checkbox unchecked=true\>';
      m += '<INPUT id=pbtargetHeavyCavalry disabled=true type=text size=6 maxlength=6 value="0"\></td></tr>';
      ...
      m += '<INPUT id=pbtargetSupplyWagon disabled=true type=text size=6 maxlength=6 value="0"\></td>';
      m += '<TD><INPUT id=pbBallista type=checkbox unchecked=true\>';
      m += '<INPUT id=pbtargetBallista disabled=true type=text size=6 maxlength=6 value="0"\></td>';
      m += '<TD><INPUT id=pbBatteringRam type=checkbox unchecked=true\>';
      m += '<INPUT id=pbtargetBatteringRam disabled=true type=text size=6 maxlength=6 value="0"\></td>';
      m += '<TD><INPUT id=pbCatapult type=checkbox unchecked=true\>';
      m += '<INPUT id=pbtargetCatapult disabled=true type=text size=6 maxlength=6 value="0"\></td></tr></table>';
