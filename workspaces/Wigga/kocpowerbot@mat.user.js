...
function pbStartup (){
  ...
  var styles = '.xtab {padding-right: 5px; border:none; background:none; white-space:nowrap;}\
    ...
    table.pbTabPad tr td.ptentry {padding-left: 8px;}\
   ...
   if (ret>0) {
     ...
     if(i.length>0) {
      ...
      if (totTime > 0) {
       ...
       messagebody += "<tr><td colspan=2>Items</td><td>Inventory</td><td>Action</td></tr>";       
       for(var d=0;d<12;d++) {
        if (d!=2) {
...
Tabs.AutoCraft = {
	...
	init: function(div){
        ...
        var m = '<DIV id=pbCraftingDiv class=pbStat>AUTO CRAFTING - SETTINGS</div><TABLE id=pbcraftingfunc width=100% height=0% class=pbTab><TR><TD width="10%">Interval: <input type=text value="'+TrainOptions.CraftIntervallMin+'" size=2  maxlength=2 id=pbCraftIntervall> Minute(s) <b>(</b><span class=boldRed>need Refresh</span><b>)</b></td>';
        ...
        m+="</table><b>Note:</b> If you complete more than one Item, the creation will be done randomly. <BR> <b>Important: Min. 5000 Aethestones and Refresh to Update the Inventory!</b> ";
